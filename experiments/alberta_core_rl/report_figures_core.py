...
def plot_scale_invariant(result_dir: Path, figure_dir: Path | None = None) -> list[Path]:
    ensure_mpl_config(repo_root())
    import matplotlib.pyplot as plt
...
def plot_dyna_aging(result_dir: Path, figure_dir: Path | None = None) -> list[Path]:
    ensure_mpl_config(repo_root())
    import matplotlib.pyplot as plt
...
def plot_dyna_drift(result_dir: Path, figure_dir: Path | None = None) -> list[Path]:
...
def plot_dyna_budget(result_dir: Path, figure_dir: Path | None = None) -> list[Path]:
    ensure_mpl_config(repo_root())
    import matplotlib.pyplot as plt
