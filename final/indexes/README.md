...
These files summarize the current state of the project without replacing the standalone reports. The canonical text for each study is its current `final/reports/**/report.md`; the canonical evidence list is `final/indexes/results.md`; reproduction assumptions and commands live in `final/indexes/reproduction.md`.

- `results.md`: current result directories and evidence status.
