...
新提交的 CPU task 是 `core-rl-scale-invariant-extended-33723554`，用于运行 `scale_invariant_continuing_control/config_extended.json`，队列为 `ailab-safethm/safethm_cpu_task`。后续检查命令：
